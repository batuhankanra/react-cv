...
export default function LoginModal() {
  ...
  return (
    <div className='flex flex-col  w-[400px]'>
      ...
      <form  className='py-3 flex flex-col gap-y-3 '>
        ...
        <input type="text" value={apassword} onChange={e=>setApassword(e.target.value)} placeholder='Şifrenizi giriniz' className='w-full p-2 outline-none border focus:border-gray-500 rounded-md ' />
